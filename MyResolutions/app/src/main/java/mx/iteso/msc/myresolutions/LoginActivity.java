...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginFormView = findViewById(R.id.svLoginForm);
        mProgressView = findViewById(R.id.bpLoginProgress);
        mRegister = (TextView) findViewById(R.id.tvRegister);
        mRegister.setText(Html.fromHtml("<font color=\"blue\"><u>" + getResources().getString(R.string.label_register) + "</u></font>"));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            return DatabaseHandler.getInstance(getApplicationContext()).userLogon(mEmail, mPassword);
        }
